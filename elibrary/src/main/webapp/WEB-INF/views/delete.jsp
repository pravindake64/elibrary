...
<!-- 
this is A delete page of Elibrary .
passing id of record to delete book record
	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="http://localhost:8080/delete">Delete
						Book</a></li>
			...
			<c:forEach items="${books}" var="c">
				<form action="deletebook" method="post">
					<tr>
						...
						<td><button type="submit" class="btn btn-danger" name="del"
								value="${c.id}">Delete</button></td>
					</tr>
				</form>
			</c:forEach>
		</tbody>
